...
import SnippetTest from '/snippets/snippet-test-4.mdx';
...
<Info>
 ...
 a - A docs repository with a `docs.json` file
</Info>

aFollow these steps to install and run Mintlify on your operating system.
